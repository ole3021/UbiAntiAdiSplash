//  ===========================================================================
//  File    Splash.h
//  Desc    The interface of the UbiSplash class
//  ===========================================================================
...
public:
	...
	//	Arg	   The location of the applciation to execute after splash screen. 
    //  =======================================================================
    USplash(LPCTSTR lpszFileName, COLORREF colTrans, LPCTSTR lpszLocation);
	...
	//  Desc   This is used to Launch Application after splash screen
	//  Ret    int
	//  =======================================================================
	...
	DWORD SetLaunchApplication(LPCTSTR lpszAppLocation);
